...
> — **the firmware's own output** — plus the palette and placement constants parsed out
> of the source, including the callout anchors. It is a view of what the C produced, not
> a second implementation of it. One theme ships today; the devicetree binding is a
> later rung.
