 ...
 * ----------------------
 * This file is Zephyr's drivers/display/display_st7789v.c, modified.
 *
 * The change adds display orientation support: MADCTL MV/MX/MY handling,
 * x_resolution and y_resolution swapped for 90 and 270 degree rotations, and
 * the panel offsets rotated with the axes. Upstream Zephyr returns -ENOTSUP
 * for any orientation other than NORMAL, which cannot drive this panel: the
 * display is a 240x280 portrait module used in landscape.
 *
 * The modification originates with carrefinho/prospector-zmk-module (MIT).
 * Redistributed here under Apache-2.0, the licence of the file it modifies.
 * See NOTICE.
 *
 * Orientation support for this controller is not Prospector-specific and
 * belongs upstream in Zephyr. If it ever lands there, delete this file and
 * the CMake shadowing in drivers/display/CMakeLists.txt with it.
 */
