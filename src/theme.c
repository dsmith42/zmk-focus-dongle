...
/* Keyboard state — the layer name today, the held modifiers at 3.4c. Hand
 * picked per theme rather than derived: the amber theme pairs its wedge with a
 * pale BLUE accent, so no single rule produces both palettes. */
